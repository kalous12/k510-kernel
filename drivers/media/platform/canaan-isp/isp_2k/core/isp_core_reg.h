...
union U_ISP_CORE_IMAGE_V_START
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_IMAGE_H_START
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_IMAGE_ACTIVE_WIDTH
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_IMAGE_ACTIVE_HEIGHT
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AE_WIN_H_START
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AE_WIN_V_START
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AE_TAR_BR_RANGE
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AE_ADJUST_CTL
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AE_ADJUST_STEP_MAX
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AE_EX_VALUE_MAX
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AE_EX_VALUE_MID
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AE_EX_VALUE_MIN
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AE_DN_SWITCH_ADJUST_STEP_MAX
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AE_DN_SWITCH_WAIT_TIME
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_APE_DRV_SIGNAL_MAX
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_APE_COEFF_DIS
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_APE_COEFF_SPEED
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_APE_COEFF_ACCE
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_APE_DRV_MANUAL_VALUE
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_APE_DAMP_MANUAL_VALUE
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AE_VALUE_READY
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AE_LONG_CUR_EX
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AE_MID_CUR_EX
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AE_SHORT_CUR_EX
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AE_CUR_DIGITAL_GAIN
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AE_CUR_AVE_BRIGHTNESS
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AE_CUR_DN_STATUS
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AWB_D65_RED_GAIN
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AWB_D65_BLUE_GAIN
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_CCM_CORRECT_COFF
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AWB_WIN_H_START
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AWB_WIN_V_START
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AWB_WIN_H_END
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AWB_WIN_V_END
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AWB_CORRECT_DIFF_TH
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AWB_RED_GAIN_ADJUST
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AWB_GREEN_GAIN_ADJUST
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AWB_BLUE_GAIN_ADJUST
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AWB_RED_MAX_VALUE
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AWB_BLUE_MAX_VALUE
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AWB_RED_MIN_VALUE
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AWB_BLUE_MIN_VALUE
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AWB_RED_OBJ_VALUE
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AWB_BLUE_OBJ_VALUE
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AWB_BLUE_HIST_VALUE
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AWB_BLUE_HIST_PIXEL
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AWB_RED_HIST_VALUE
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AWB_RED_HIST_PIXEL
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AWB_BYPASS_BLUE_HIST_VALUE
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AWB_BYPASS_BLUE_HIST_PIXEL
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AWB_BYPASS_RED_HIST_VALUE
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AWB_BYPASS_RED_HIST_PIXEL
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AWB_RED_VALUE
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AWB_GREEN_VALUE
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AWB_BLUE_VALUE
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AWB_ORG_RED_VALUE
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AWB_ORG_GREEN_VALUE
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AWB_ORG_BLUE_VALUE
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_WDR_OVER_EX_RATIO_TH1
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_WDR_OVER_EX_RATIO_TH2
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_WDR_FUSION_RATIO_TH
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_WDR_FUSION_VALUE1
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_WDR_FUSION_VALUE2
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_ADA_STAT_MAX_VALUE
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_ADA_AD_STREN_MAX_VALUE
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_ADA_WIN_H_START
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_ADA_WIN_V_START
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_ADA_WIN_H_END
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_ADA_WIN_V_END
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_RGBIR_RPC_MAX_VALUE
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_RGBIR_RPC_COLOR_COFF
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_RGBIR_RPC_LUMA_COFF
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_RGBIR_RPC_TH1
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_2DNR_RAW_INTENSITY
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_2DNR_BAP_INTENSITY
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_2DNR_EDGE_INTENSITY
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_2DNR_LUMA_INTENSITY
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_2DNR_CHROMA_INTENSITY
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_3DNR_PRE_LUMA_TH
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_3DNR_PRE_LUMA_INTENSITY
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_3DNR_PRE_CHROMA_INTENSITY
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_3DNR_MID_FILTER_TH
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_3DNR_PRE_MID_FILTER_TH
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_3DNR_CUR_FILTER_TH
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_3DNR_LOW_PASS_FILTER_TH
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_3DNR_MIN_VALUE
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_3DNR_LUMA_INTENSITY
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_3DNR_CHROMA_INTENSITY
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_3DNR_POST_EDGE_TH
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_3DNR_POST_LUMA_INTENSITY
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_3DNR_POST_CHROMA_INTENSITY
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_LDC_H_CENTER_POS
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_LDC_V_CENTER_POS
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_LDC_RECTIFY_CR
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_LDC_RECTIFY_CZ
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_RAM_RD_STATUS
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_RAM_READ_LOCK
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AF_STAT_WIN_H_START
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AF_STAT_WIN_V_START
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AF_STAT_WIN_H_END
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AF_STAT_WIN_V_END
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AF_MID_FRQ_DATA
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AF_HIGH_FRQ_DATA
{
    /* Define the struct bits */
    struct
    {
...
union U_ISP_CORE_AF_STAT_PIXEL_NUM
{
    /* Define the struct bits */
    struct
    {
