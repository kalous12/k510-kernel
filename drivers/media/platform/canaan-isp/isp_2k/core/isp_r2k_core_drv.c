...
*AWB
*/
int Isp_Drv_R2k_Core_SetAwbCtl(struct k510_isp_device *isp,ISP_CORE_AWB_CTL_S *pstAwbCtl)
{
	...
	isp_reg_writel(isp, stRedObjValue.u32,ISP_IOMEM_R2K_CORE,ISP_CORE_AWB_RED_OBJ_VALUE);
	...
	isp_reg_writel(isp, stBlueObjValue.u32,ISP_IOMEM_R2K_CORE,ISP_CORE_AWB_BLUE_OBJ_VALUE);
...
*CSC
*/
int Isp_Drv_R2k_Core_SetCscCtl(struct k510_isp_device *isp,ISP_CORE_CSC_CTL_S *pstCscCtl)
{
...
int Isp_Drv_R2k_Core_SetPostSatuCtl(struct k510_isp_device *isp,ISP_CORE_POST_CTL_S *pstPostCtl)
{
